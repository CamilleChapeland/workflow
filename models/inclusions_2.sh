...
intt=def poly=0 cp=2500 ro=2600 x=870,875,880,885,890 z=41,40,39,40,41 \
intt=def poly=0 cp=1600 ro=1900 x=870,875,880,885,890 z=41,42,43,42,41 \
...
intt=def poly=0 cp=2000 ro=1800 x=800,810,820,830,840,850 z=44,43.6,43.2,43,43.4,44 \
intt=def poly=0 cp=2800 ro=2500 x=800,810,820,830,840,850 z=44,44.4,44.8,45,44.8,44 \
...
intt=def poly=0 cp=2300 ro=2000 x=745,750,760,770,775 z=51,50,49,50,51 \
intt=def poly=0 cp=1600 ro=1700 x=745,750,760,770,775 z=51,52,53,52,51 \
...
suwind min=1625 max=2375 < Data/$4/vel0f.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 > Data/$4/vel0.su
suwind min=1625 max=2375 < Data/$4/velf.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 > Data/$4/vel.su
suwind min=1625 max=2375 < Data/$4/denf.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 > Data/$4/den.su
