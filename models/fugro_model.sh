...
dxrcv=0.4
suwind min=1001 max=1751 < ../Data/$4/vel0f.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 | \
...
suwind min=1001 max=1751 < ../Data/$4/velf.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 | \
interpolate d2out=$dxrcv verbose=1 | \
sushw key=gx a=0 b=$dxrcv | sushw key=offset,f2 a=0,0 b=$dxrcv,$dxrcv | sushw key=scalco,trid a=0,30 > ../Data/$4/truvel.su
suwind min=1001 max=1751 < ../Data/$4/denf.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 | \
interpolate d2out=$dxrcv verbose=1 | \
...
suwind min=1001 max=1751 < ../Data/$4/vel0f.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 | \
interpolate d2out=$dxrcv verbose=1 | \
sushw key=gx a=0 b=$dxrcv |sushw key=offset,f2 a=0,0 b=$dxrcv,$dxrcv | sushw key=scalco,trid a=0,30 > ../Data/$4/vel02.su
suwind min=1001 max=1751 < ../Data/$4/velf.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 | \
interpolate d2out=$dxrcv verbose=1 | \
sushw key=gx a=0 b=$dxrcv | sushw key=offset,f2 a=0,0 b=$dxrcv,$dxrcv | sushw key=scalco,trid a=0,30 > ../Data/$4/truvel2.su
suwind min=1001 max=1751 < ../Data/$4/denf.su | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 | \
interpolate d2out=$dxrcv verbose=1 | \
sushw key=gx a=0 b=$dxrcv | sushw key=offset,f2 a=0,0 b=$dxrcv,$dxrcv | sushw key=scalco,trid a=0,30 > ../Data/$4/den2.su
