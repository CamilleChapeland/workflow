...
intt=def poly=0 cp=330 ro=10 x=500,520,540,560,580,600,620,640,660,680,700 z=42,41.8,41.6,41.4,41.2,41,41.2,41.4,41.6,41.8,42 \
intt=def poly=0 cp=2800 ro=2500 x=500,520,540,560,580,600,620,640,660,680,700 z=42,42.2,42.4,42.6,42.8,43,42.8,42.6,42.4,42.2,42 \
...
dxrcv=2
suwind min=1001 max=1751 < ../Data/$4/vel0f.su verbose=1 | sushw key=trwf a=751 | sushw key=tracf,tracl a=1,1 b=1,1 | \
